  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/backend/js/js_global_frontend.js?<?php echo date("Ymdgis");?>"></script>
    ...
    <script type="text/javascript">
       ...
       tinymce.init({
                ...
                /*jQuery(function() {
                    alert();
                    var scrn = (screen.width-400)+"px !important";
                    jQuery("#wrapper").css("width",scrn);   
                });
                */
				
			if(jQuery( window ).width() > 1024)
			{
				//jQuery(".tundra").addClass("page-sidebar-mobile-main");
			}
    </script>
   
  </head>
   <body class="tundra page-sidebar-mobile-main">
    
    <div id="wrapper" class="edit-form-wrapper">
