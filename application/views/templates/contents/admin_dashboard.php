        ...
        <div class="col-lg-12">
            ...
            <div class="panel default2 shadow">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h3 class="panel-title">Welcome {$user_name}</h3>
                    </div>
                ...
                <div class="panel-body no-padding col-md-12">
                    ...
                    <div id="ember1099" class="ember-view"><div class="w-column  col-sm-6 ">
                            ...
                            <small>Last 5 actions ( <a id="ember1100" href="{base_url('dashboard/actions')}" class="ember-view">see all</a> )</small>
                            <div id="ember1125" class="ember-view"><ul class="list-group clear-list m-t">
                                    ...
                                    <li class="list-group-item">
                                        <span class="pull-right">{$row->time}</span>
                                        <span class="label label-info">{$i++}</span> <span style="color: #00a0d1">{$row->username}</span> <span id="ember1142" class="ember-view">   {$row->what}
</span>
                                    </li>
