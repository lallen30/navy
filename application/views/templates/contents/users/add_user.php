                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <select required name="user_role" class="form-control">
                                ...
                                {if $group_id==1}
                                <option value="{$role->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$role->id})}Selected{/if}{/if}>{$role->name}</option>
                                {/if}
                                {/foreach}
                                {if $group_id!=1}
                                <option value="{$roles[1]->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$roles[1]->id})}Selected{/if}{/if}>{$roles[1]->name}</option>
                                <option value="{$roles[2]->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$roles[2]->id})}Selected{/if}{/if}>{$roles[2]->name}</option>
                                <option value="{$roles[3]->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$roles[3]->id})}Selected{/if}{/if}>{$roles[3]->name}</option>
                                <option value="{$roles[4]->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$roles[4]->id})}Selected{/if}{/if}>{$roles[4]->name}</option>
                                <option value="{$roles[5]->id}" {if isset($user_detail)}{if ($user_detail[0]->group_id=={$roles[5]->id})}Selected{/if}{/if}>{$roles[5]->name}</option>
