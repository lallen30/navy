    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                    ...
                    <a class="btn btn-twitter btn-stroke" href="{base_url('user/add')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add User</a>
                    {if isset($message)}
            ...
            <form method="post" action="{base_url('user/delete_multiple_user')}">
            <div class="panel">
