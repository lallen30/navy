...
<div class="body-content animated fadeIn">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="detail_user_div">
            ...
            <form id="add_procedure" method="post" >
            <div class="panel default2 shadow">
                ...
                <div class="panel-body no-padding col-md-6" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Process ABR</label>
                                <input required name="process_abr" value="{if isset($detail)}{$detail->process_abr}{/if}" class="form-control" type="text">
                            </div>
                            <div class="form-group">
...
<!--                            </div>-->
                    ...
                    <div class="form-footer" >
                        <div class="pull-right" id="hide_buttons">
                            {if isset($detail)}
                            <a class="btn btn-danger btn-stroke" href="{base_url('welding/process_detail')}/{$detail->id}"> <i class="fa fa-eraser" aria-hidden="true"></i>   Cancel</a>
