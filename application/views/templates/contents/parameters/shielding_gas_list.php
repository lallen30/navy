    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_shielding_gas')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Shielding Gas</a>
                {if isset($message)}
            ...
            <form method="post" action="{base_url('parameters')}/delete_shielding_gas">
