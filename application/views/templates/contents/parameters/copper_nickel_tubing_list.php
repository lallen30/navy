    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_copper_nickel_tubing')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Copper Nickel Tubing Thickness</a>
                {if isset($message)}
            ...
            <form method="post" action="{base_url('parameters')}/delete_copper_nickel_tubing">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table id="copper_nickel_tubing"  class="display" cellspacing="0" width="100%">
