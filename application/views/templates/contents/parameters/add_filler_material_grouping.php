...
<div class="body-content animated fadeIn">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="detail_user_div">
            ...
            <form id="add_filler_material_grouping" method="post" >
                    ...
                    <div class="panel-body no-padding col-md-6" >
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label"> Filler Material Group </label>

                                <select required name="qualified_filler_group_id" class="form-control">
                                    <option value="" >Select</option>

                                    {foreach from=$Qualified_filler_groups  item=group}
                                    <option value="{$group->id}" {if isset($detail)}{if ($detail->qualified_filler_group_id==$group->id)}Selected{/if}{/if}>{$group->filler_metal_group}</option>
                                    {/foreach}

                                </select>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Specification No</label>
                                <input required name="specification_no" value="{if isset($detail)}{$detail->specification_no}{/if}" class="form-control" type="text">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Electrode</label>
                                <em class="help-block no-margin">Add Pipe(" |") Symbol for separation (ex: 6010  | 6011  | 6012 ...etc)</em>
                                <textarea rows="5" cols="70"  name="electrode" required >{if isset($detail)}{$detail->electrode	}{/if}</textarea>
                            </div>
                            <!--                            <div class="form-group">-->
