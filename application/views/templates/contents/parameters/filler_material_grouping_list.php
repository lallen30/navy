    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_filler_material_grouping')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Filler Material Grouping</a>
                {if isset($message)}
            ...
            <form method="post" action="{base_url('parameters')}/delete_filler_material_grouping">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table id="filler_material_grouping" class="display" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <th></th>
                                <th>Process Name</th>
                                <th>Filler Metal Group </th>
                                <th>Filler Group Welder Qualifies </th>
