                    ...
                    <div class="panel-body no-padding" >
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input required class="form-control" value="{if isset($detail)}{$detail->gas_name}{/if}" name="gas_name" type="text">
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                <label class="control-label">Gas Abbreviation</label>

                                <input required class="form-control" value="{if isset($detail)}{$detail->gas_abbreviation}{/if}" name="gas_abbreviation" type="text">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" cols="70" name="percentage">{if isset($detail)}{$detail->percentage}{/if}</textarea>
                            </div>
