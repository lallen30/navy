    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_test_assemblies')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Test Assemblies and Joint Design</a>
                {if isset($message)}
            ...
            <form method="post" action="{base_url('parameters')}/delete_test_assemblies">
