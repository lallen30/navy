...
<!--            {if in_array('welding/add_process',$pages) }-->
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_process')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Process</a>
                {if isset($message)}
...
<!--            {/if}-->
            ...
            <form method="post" action="{base_url('parameters')}/delete_process">
            <div class="panel">
                ...
                <div class="panel-body">
                    <table id="process" class="display" cellspacing="0" width="100%">
