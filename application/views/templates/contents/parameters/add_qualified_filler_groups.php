...
<div class="body-content animated fadeIn">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="detail_user_div">
            ...
            <form id="add_qualified_filler_group" method="post" >
                    ...
                    <div class="panel-body no-padding col-md-6" >
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label"> Weld Process </label>

                    <select required name="process_id" class="form-control">
                        <option value="" >Select</option>

                        {foreach from=$process_list  item=process}
                        <option value="{$process->id}" {if isset($detail)}{if ($detail->process_id==$process->id)}Selected{/if}{/if}>{$process->process_name}</option>
                        {/foreach}

                    </select>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Filler Metal Group</label>
                                <input required name="filler_metal_group" value="{if isset($detail)}{$detail->filler_metal_group}{/if}" class="form-control" type="text">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Filler Group Welder Qualifies</label>
                                <input required name="filler_group_welder_qualifies" value="{if isset($detail)}{$detail->	filler_group_welder_qualifies	}{/if}" class="form-control" type="text">
                            </div>
                            <!--                            <div class="form-group">-->
