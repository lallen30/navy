    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel top-button">
                ...
                <a class="btn btn-twitter btn-stroke" href="{base_url('parameters/add_qualified_filler_groups')}"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Add Qualified Filler Groups</a>
                {if isset($message)}
            ...
            <form method="post" action="{base_url('parameters')}/delete_qualified_filler_groups">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <table id="qualified_filler_groups" class="display" cellspacing="0" width="100%">
