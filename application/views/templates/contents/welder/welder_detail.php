                    ...
                    <form class="form-horizontal" id="input-mask">
                        ...
                        <div class="form-footer">
                            <div class="pull-right">
                                {if in_array('welding/vision_test',$pages) }
                                <a class="btn btn-twitter btn-stroke"  href="{base_url('welding/vision_test')}/{$user_detail[0]->id}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vision Test</a>
                                {/if}
                                {if in_array('welding/vision_consent',$pages) }
                                <a class="btn btn-twitter btn-stroke"  href="{base_url('welding/vision_consent')}/{$user_detail[0]->id}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vision Consent</a>
                                {/if}
                               ...
                               {/if}
                                {if in_array('welding/edit_welder',$pages) }
                                <a class="btn btn-twitter btn-stroke"  href="{base_url('welding/edit_welder')}/{$user_detail[0]->id}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                {/if}
                            </div>
                            <div class="clearfix"></div>
                        </div>
