...
<!--                                    <option value="1" {if isset($user_detail)}{if ($user_detail[0]->group_id=='1')}Selected{/if}{/if}>Administrator</option>-->
<!--                                    <option value="2" {if isset($user_detail)}{if ($user_detail[0]->group_id=='2')}Selected{/if}{/if}>Nurse/ Vision Test Coordinator </option>-->
<!--                                    <option value="3" {if isset($user_detail)}{if ($user_detail[0]->group_id=='3')}Selected{/if}{/if}>Welder</option>-->
<!--                                    <option value="4" {if isset($user_detail)}{if ($user_detail[0]->group_id=='4')}Selected{/if}{/if}>Welding Coordinators </option>-->
<!--                                    <option value="5" {if isset($user_detail)}{if ($user_detail[0]->group_id=='5')}Selected{/if}{/if}>Department welding processors-</option>-->
<!--                                    <option value="6" {if isset($user_detail)}{if ($user_detail[0]->group_id=='6')}Selected{/if}{/if}>Read access</option>-->
<!---->
<!--                                </select>-->
<!---->
<!--                            </div><!-- /.form-group -->
                    ...
                    <div class="panel-body no-padding col-md-6" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input  name="street_address" value="{if isset($user_detail[0])}{$user_detail[0]->street_address}{/if}" class="form-control" type="text">
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group" >
                                ...
                                <input  name="emergency_contact_person" value="{if isset($user_detail[0])}{$user_detail[0]->emergency_contact_person}{/if}" class="form-control" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <input  name="emergency_contact_number" value="{if isset($user_detail[0])}{$user_detail[0]->emergency_contact_number}{/if}" class="form-control phone"   onBlur='addDashes(this)' type="text">
                            </div>
                        </div>
                    ...
                    <div class="form-footer col-md-12" >
                        <div class="pull-right" id="hide_buttons">
                            {if isset($user_detail)}
                            <a class="btn btn-danger btn-stroke" href="{base_url('user/detail')}/{$user_detail[0]->id}"> <i class="fa fa-eraser" aria-hidden="true"></i>   Cancel</a>
