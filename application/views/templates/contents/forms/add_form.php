                    ...
                    <div class="panel-body no-padding" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required class="form-control" value="{if isset($detail)}{$detail->description}{/if}" name="description" type="text">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Url of form</label>
                                <textarea rows="5" type="url" cols="70" name="code">{if isset($detail)}{$detail->code}{/if}</textarea>
                            </div>
                        ...
                        <div class="form-footer" >
                            <div class="pull-right" id="hide_buttons">
                                {if isset($detail)}
                                <a class="btn btn-danger btn-stroke" href="{base_url('form/form_management')}"> <i class="fa fa-eraser" aria-hidden="true"></i>   Cancel</a>
