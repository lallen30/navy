 ...
 */
$config['site_title']                 = "http://navy.testplanets.com";       // Site Title, example.com
$config['admin_email']                = "admin@navy.testplanets.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Administrator';           // Default group, use name
$config['admin_group']                = 'Administrator';             // Default administrators group, use name
